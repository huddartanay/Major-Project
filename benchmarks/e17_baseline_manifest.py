...
E17_CODE = [
    ...
    "training/closed_loop.py",
    "training/faults.py",
    "training/redundant.py",
]
E17_DOCS = sorted((ROOT / "research").glob("E17_*.md"))
ARTIFACTS = [
    "var/policy/synthetic.pt",
    "var/policy/long.pt",
    "var/policy/jerkscaled.pt",
            ...
            rows.append(
                {
                    ...
                    "bytes": p.stat().st_size,
                    "sha256": sha256(p),
                    "description": "E17 experiment / harness code",
                }
            )
    for p in E17_DOCS:
        rows.append(
            ...
            rows.append(
                {
                    ...
                    "bytes": p.stat().st_size,
                    "sha256": sha256(p),
                    "description": "policy checkpoint / calibration corpus",
                }
            )
